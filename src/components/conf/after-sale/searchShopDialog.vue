<template>
    <div class="after-sale-search-dialog">
        <el-dialog title="选择店铺" :visible.sync="isShow" size="small" :before-close="beforeCloseDialog">
            ...
            <el-table :data="formEntity"  v-loading="listLoading" highlight-current-row>
                ...
                <el-table-column property="shopMdCode" label="店铺编码"></el-table-column>
                <el-table-column property="shopName" label="店铺名称" width="240"></el-table-column>
...
<style>
    .after-sale-search-dialog .el-radio__label{
        display:none;
    }
</style>
    ...
    <section>
      <el-col :span="24" class="mod-toolbar">
        <el-form :rules="rules" ref="ruleForm" :model="formEntity" label-width="100px" label-position="left"
                ...
                <el-table-column label="属性名称" width="300">
                  <template scope="scope">
                    <el-form-item class="validate-table-error"
                                  ...
                                  :rules="rules.commonText"
                    >
                      <el-input v-model="scope.row.propsName" placeholder="请输入属性名称"></el-input>
                    </el-form-item>
                  </template>
                </el-table-column>
          ...
          <el-form-item label="详细参数" prop="propsGroupList">
            <el-col>
                ...
                <el-table-column>
                  <template scope="scope">
                    <el-table
                      ...
                      style="width: 100%">
                      <el-table-column label="参数名称" prop="propsName">
          ...
          <el-form-item label="自定义TAB" prop="tabLabelList">
            <el-col>
  ...
  export default {
    ...
    data(){
      return {
        ...
        titles: [{id: 1, name: '商品中心'}, {id: 2, name: '属性管理'}, {id: 3, name: '属性新增'}],
        formEntity: {
          typeId: '',
          typeName: '',
          // add添加,edit编辑

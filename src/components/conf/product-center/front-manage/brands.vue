<template>
    <el-dialog title="品牌搜索" :visible.sync="dialogBrands" :before-close="handleClose">
        <el-form :model="form">
        ...
        <el-table
            ...
            <el-table-column prop="brandName" label="品牌名称" width="448"></el-table-column>
        </el-table>
...
export default {
    ...
    methods: {
        ...
        confirm(){
            this.form.name = ''
            this.onSearch()
            this.$emit('brands', this.multipleSelection)
        }
    },
}
</script>

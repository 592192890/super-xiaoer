    ...
    <section>
      <el-col :span="24" class="mod-toolbar">
        <el-form :rules="rules" ref="ruleForm" :model="formEntity" label-width="100px" label-position="left"
          ...
          <el-form-item label="国家LOGO" prop="countryFlagIco" required
  ...
  export default {
    ...
    data(){
      ...
      return {
        ...
        errorTips: '',
        provinceList: [],
        titles: [{id: 1, name: '商品中心'}, {id: 2, name: '国家管理'}, {id: 3, name: '国家新增'}],
        formEntity: {
          countryCode: '',
          countryName: '',
          countryEnName: '',
    ...
    methods: {
      /**
       * 国家新增
       * @param formName 国家表单名
       */
      add: function (formName) {
        this.$refs[formName].validate((valid) => {
          if (valid) {
            let url = this.$apiUrl.addCountryUrl

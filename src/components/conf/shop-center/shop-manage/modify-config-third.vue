		...
		<section>
			<el-col :span="24" class="mod-toolbar">
                ...
                <el-form-item label="结算周期" >
                    <el-row :gutter="20">
                        <el-col :span="6">
                            <el-select v-model="formEntity.settleDays" placeholder="请选择">
                                <el-option
                ...
                <el-form-item label="店铺有效期至" >
                    <el-row :gutter="20">
                        <el-col :span="6">
                            <el-date-picker
                              v-model="formEntity.validDate"
                              type="date"
                              placeholder="选择日期" @change="selectValidDate" :picker-options="pickerOptions0">
                            </el-date-picker>
                        </el-col>
                    </el-row>
                </el-form-item>
                        ...
                        <el-row :gutter="20">
                            <el-col :span="20">
                                <el-table :data="formEntity.productType" ref="multipleTable" highlight-current-row style="margin-left:10px">
                                    ...
                                    <el-table-column prop="percentage" label="抽佣比例">
                                    </el-table-column>
                                    <el-table-column prop="securityFee" label="保证金">
                                    </el-table-column>
...
<script>
    ...
    export default {
        ...
        data(){
            return{
                titles:[{id:1,name:'店铺中心'},{id:2,name:'店铺管理'},{id:3,name:'修改第三方店铺配置'}],
                pickerOptions0: {
                    disabledDate(time) {
        ...
        methods:{
            confirm(){
                ...
                /*if(this.formEntity.productType[0] && this.formEntity.productType[0].firstCategory == this.firstCategory){
                    if(this.formEntity.productType[1] && this.formEntity.productType[1].secondCategory == this.secondCategory){
                        if(this.formEntity.productType[2] && this.formEntity.productType[2].firstCategory == this.firstCategory){
            ...
            selectValidDate(onPick){
                this.formEntity.validDate = onPick
            },
            ...
            goSave(){
                ...
                let params = {
                    ...
                    validDate: this.formEntity.validDate,
                    settleDays: this.formEntity.settleDays
                }

                let url=this.$apiUrl.configOtherUrl;
        ...
        mounted(){
            ...
            this.$ajax.get(this.$apiUrl.getSettledaysTypesUrl,{}).then(res=>{
            ...
            this.$ajax.get(url1, param1).then(res =>{
                ...
                this.$ajax.post(url2, param2).then(res =>{
                    if(res.error) return
                    this.formEntity.productType = res.data.businessCategories;
                    if(this.formEntity.productType&&this.formEntity.productType.length){
                        this.formEntity.productType.forEach(item=>{
                            item.percentage = item.percentage ? item.percentage + "%" : "无";
                            item.securityFee = item.securityFee ? item.securityFee + "元": "无";
                        })
                    }
                    this.formEntity.settleDays = res.data.businessInfo && res.data.businessInfo.settleDays;
                    this.formEntity.validDate = res.data.validDate;

		...
		<section style="margin-top:20px">
            <div class="company mod-toolbar">
                ...
                <el-row class="last-row">
                    ...
                    <el-col :span="6">
                            <img :src="formEntity.businessImg.businessUrl"></img>
                        </el-col>
                        <el-col :span="4">
                            <div class="label">特许经营资质扫描件</div>
                        </el-col>
                    <el-col :span="6">
                        <img :src="formEntity.businessImg.franchisingUrl"></img>
                    </el-col>
                </el-row>
            </div>
            <div class="finance mod-toolbar">
                ...
                <el-col :span="6">
                        <img :src="formEntity.businessImg.bankPermitsUrl"></img>
                    </el-col>
                    <el-col :span="4">
                        <div class="label">税务登记证扫描件</div>
                    </el-col>
                <el-col :span="6">
                        <img :src="formEntity.businessImg.registrationUrl"></img>
                    </el-col>
                </el-row>
            </div>
            ...
            <div class="payment mod-toolbar">
                ...
                <el-row>
                    ...
                    <el-col :span="6">
                        <div class="right">{{formEntity.businessInfo.businessFinaceSystem=='EBS'?'EBS':''}}</div>
                    </el-col>
                    <el-col :span="4">
                ...
                <el-row>
                    ...
                    <el-col :span="18">
                        <div class="right">{{formEntity.businessInfo.payProoRemark}}</div>
                    </el-col>
                ...
                <el-row>
                    ...
                    <el-col :span="6">
                        <img :src="formEntity.businessImg.payProofUrl"></img>
                    </el-col>
                ...
                <el-row class="last-row">
                    ...
                    <el-col :span="6">
                        <div class="right">{{formEntity.businessInfo.merchantsFailReason}}</div>
                    </el-col>
...
<script>
    ...
    export default {
        ...
        data(){
            return{
                titles:[{id:1,name:'店铺中心'},{id:2,name:'店铺管理'},{id:3,name:'查看第三方店铺'}],
                formEntity:{
                    businessInfo:{},
                    businessImg:{},
                    options:{},
        ...
        mounted(){
            ...
            var url=this.$apiUrl.getShopDetailUrl+'?shopId='+shopId;
            ...
            this.$ajax.get(url).then((res)=>{
                ...
                if(!this.formEntity.businessInfo){
                    this.formEntity.businessInfo={};
                }

    ...
    <div class="active-order">
		...
		<section class="header" style="margin-top:20px">
            ...
            <el-row :span="24" class="mod-toolbar" :gutter="5">
				...
				<el-col :span="4">
					<el-input v-model="searchEntity.exParamValue" placeholder="请输入订单号/活动卷码"></el-input>
				</el-col>
			...
			ref="multipleTable" style="width: 100%;" v-loading="listLoading">
				...
				<el-table-column label="操作" width="140">
					<template scope="scope">
						...
						<span class="cancel-btn" @click="handleCancel(scope.$index, scope.row)" v-if="scope.row.orderStatus=='待付款'&&buttonArr.indexOf('bt-cancel')!=-1">取消</span>
					</template>
				</el-table-column>
			</el-table>
			<!--工具条-->
...
<script>
    ...
    export default {
        ...
        data(){
            let self = this;
            return {
                titles:[{id:1,name:'交易'},{id:2,name:'活动订单管理'}],
                buttonArr:[],
        ...
        methods:{
            ...
            exportOrders:function(){
                var url=this.$apiUrl.exportsActiveOrdersUrl;
            ...
            search:function(index){
                ...
                var url=this.$apiUrl.getActiveOrderListUrl;
            ...
            handleView:function(index,row){
                this.$router.push({name:'活动订单管理查看',params:{entity:row}})
            },
        ...
        mounted(){
            ...
            this.search();
            this.getSelectAll('orderStatusActivity').then(res=>{
                if(res.error==0){
            ...
            this.getSelectAll('exParamNameActivity').then(res=>{
                if(res.error==0){

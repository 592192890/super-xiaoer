    ...
    <div>
        ...
        <section class="header" style="margin-top:20px">
            <el-row :span="24" class="mod-toolbar" :gutter="5">
                <el-button class="primary" @click="goBack">返回订单列表</el-button>
            </el-row>
             ...
             <el-tabs type="border-card" v-model="activeName">
                    ...
                    <section>
                        <div class="mod-toolbar">
                            ...
                            <el-row :gutter="40">
                                ...
                                <el-col :span="20">
                                    <div class="label item">{{formEntity.shippingInfo.waybillNos}}</div>
                                </el-col>
                            </el-row>
                        </div>   
                    </section>
                    ...
                    <section>
                        <div class="mod-toolbar">
                            ...
                            <section>
                                ...
                                <el-row :gutter="40">
                                    <el-table :data="formEntity.orderItemsList" highlight-current-row style="width: 100%;margin-left:20px">
                ...
                <el-tab-pane label="订单备注" name="second">
                    <section>
                        <div class="mod-toolbar">
                            <el-row>
                                <el-input type="textarea" :rows="2" placeholder="请输入1-250个字符" v-model="comment">
                                </el-input>
                            </el-row>
                            <el-row :gutter="40">
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            goBack:function(){
                if(this.$route.name=='活动订单管理查看'){
                    this.$router.push({name:'活动订单管理列表'})
                }else{
                    this.$router.push({name:'订单管理列表'})
                }
            },
            getDetail:function(orderId,type){
                if(type=="active"){
                    var url=this.$apiUrl.getActiveOrderDetailUrl;
                }else{
        ...
        mounted(){
            if(this.$route.params.entity){
                sessionStorage.setItem('orderId',this.$route.params.entity.orderId)
                sessionStorage.setItem('shopId',this.$route.params.entity.shopId)
            }
            var orderId=sessionStorage.getItem('orderId');
            //判断是活动订单管理还是订单管理
            if(this.$route.name=='订单管理查看'){
                this.titles=[{id:1,name:'交易'},{id:2,name:'订单管理'},{id:3,name:'订单管理查看'}];
                this.getDetail(orderId);
            }else{
                this.titles=[{id:1,name:'交易'},{id:2,name:'活动订单管理'},{id:3,name:'活动订单管理查看'}];
                this.getDetail(orderId,'active');
            }
            //获取备注列表
            this.getCommentList();
        }
